...
Update 5-24: Now preliminary version is on shinyapps.io, but having issues with ggplot currently, so no plot on results page. Use the above runGithub() method for now...
...
- ~~produce a results plot, norms, and any other information to interpret the results~~
  - QUESTION: plot distribution sd = 1.48? Also, harder to get >3 or <3 in ability...
- ~~click sound~~
- ~~Make it pretty~~
