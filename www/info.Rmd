---
title: "Shiny Computer Adapative Philadelphia Naming Test"
author: "Alex Swiderski, Rob Cavanaugh...G? WH?"
output:
  github_document:
    keep_html: true
---
...
- what are the advantages of CAT + PNT
  - why naming assessments? (brief, high correlations to overall severity, discourse...etc)
- what you don't get from CAT + PNT (error stuff)
- other details about where the current CAT + PNT reserach stands
- how to leave feedback, report issues or ask questions (ideally github issues but also contact info)
